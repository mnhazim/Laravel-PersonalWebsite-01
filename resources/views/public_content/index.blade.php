...
<!-- 1 SECTION START -->
<section class="py-0">
   <div class="container-fluid" style="height: 100vh;background-color: black;" id="vantanet">
      <!-- Github Link -->
      ...
      <!-- Text In The Middle -->
      <div class="row mx-3 align-items-end h-50" style="margin-top: -45px;">
...
<!-- 2 SECTION START -->
<section class="py-0">
   <div class="container" id="home" style="padding-top: 7.5rem;padding-bottom: 7.5rem;">
      <div class="row align-items-center" id="vantabird">
         <div class="col-sm-8 col-lg-10 col-xl-4 text-xl-right mt-5 mt-xl-0 order-lg-1 order-2 pr-xl-4">
         ...
         <div class="col-sm-8 col-lg-5 col-xl-4 mt-4 mt-xl-0 px-xl-4 order-lg-2">
            <img class="w-100 radius-primary" src="images/model6.png" alt="" style="filter: blur(0px); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
         </div>
         <div class="col-sm-8 col-lg-5 col-xl-4 mt-5 mt-xl-0 order-3 align-self-lg-start align-self-xl-center pl-xl-4">
            <div class="overflow-hidden">
            ...
            <div class="overflow-hidden">
               ...
               <div class="py-2 mx-auto">
                  <a href="#" class=""><img src="images/icon/i-git.png" height="50"></a>
                  <a href="#" class=""><img src="images/icon/i-in.png" height="50"></a>
                  <a href="#" class=""><img src="images/icon/i_ig.png" height="50"></a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div id="sharing" class="container" >
         ...
         <div class="row">
            <div class="col-lg-12 my-4">
               <center><a href="" class="btn btn-outline-danger btn-sm">See More</a></center>
            </div>
         </div>
      </div>
   </div>
...
<section class="py-0" id="portfolio" style="background-color: white;">
   <div class="container" >
      ...
      <div class="row">
         <div class="col-lg-12 my-4">
            <center><a href="/activity" class="btn btn-outline-dark btn-sm">See More</a></center>
         </div>
      </div>
      <!--Grid row-->
   </div>
...
<section class="py-0" id="sharing" style="background-color: #fafafa;">
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-12 my-4">
            <center><a href="/sharing" class="btn btn-outline-primary btn-sm">See More</a></center>
         </div>
      </div>
   </div>
</section>
...
<!-- 6 SECTION END -->
<!-- 7 SECTION START -->
<section class="text-center text-white border-top border-color-9 py-4" id="software-cta" style="background-color: black;">
   <div class="container">
